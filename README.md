...
7. In vscode, go to 'file --> new file', and paste your notebook/notes into the file, and save it in the 'GEN711_811_Practical-Exam' repo.For the practical, you should only need one vscode window open, and one terminal open.
